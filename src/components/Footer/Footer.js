...
function Footer() {
    return (
        <>
            ...
            <div className="text-center d-flex justify-content-center align-items-center" style={{backgroundColor : "#11999E" , color : "#E4F9F5"}}>
                <i class="fa-regular fa-copyright" style={{fontSize : "15px" , marginLeft : "5px"}}></i>
                {/* <h6 style={{color : "#E4F9F5" , marginRight : "10px"}}>طراحی شده توسط سهیل حسینی</h6> */}
